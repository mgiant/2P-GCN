...
class ST_GCN_18(nn.Module):
    ...
    """
    def __init__(self, in_channels, kernel_size, num_class, A, edge_importance_weighting=True, data_bn = True, **kwargs):
        super().__init__()
        ...
        self.st_gcn_networks = nn.ModuleList((
            st_gcn_block(in_channels, 64, s_kernel_size, t_kernel_size, A, 1, residual=False, **kwargs0),
            st_gcn_block(64, 64, s_kernel_size, t_kernel_size, A, 1, **kwargs),
            st_gcn_block(64, 64, s_kernel_size, t_kernel_size, A, 1, **kwargs),
            st_gcn_block(64, 64, s_kernel_size, t_kernel_size, A, 1, **kwargs),
            st_gcn_block(64, 128, s_kernel_size, t_kernel_size, A, 2, **kwargs),
            st_gcn_block(128, 128, s_kernel_size, t_kernel_size, A, 1, **kwargs),
            st_gcn_block(128, 128, s_kernel_size, t_kernel_size, A, 1, **kwargs),
            st_gcn_block(128, 256, s_kernel_size, t_kernel_size, A, 2, **kwargs),
            st_gcn_block(256, 256, s_kernel_size, t_kernel_size, A, 1, **kwargs),
            st_gcn_block(256, 256, s_kernel_size, t_kernel_size, A, 1, **kwargs),
        ))
...
class st_gcn_block(nn.Module):
    ...
    """
    def __init__(self, in_channels, out_channels, spatial_kernel_size, temporal_kernel_size, A, stride=1, dropout=0, residual=True, adaptive=False, **kwargs):
        super().__init__()
